...
//   }
  ...
  _getstaffclass(String? staffId) async {
    ...
    final String url =
        'https://stmaryswilliamnagarapi.lumensof.in/api/Exam/GetClassList?staff_Id=$staffId';
    try {
...
//edit2
    final String url =
        'https://stmaryswilliamnagarapi.lumensof.in/api/Exam/GetSectionList?staffId=$staffId&classId=$classId';
